...
public class InspeccionReciboGUI22 extends javax.swing.JFrame {
    ...
    public InspeccionReciboGUI22() {
        initComponents();
    }

    public InspeccionReciboGUI22(Usuarios usuario) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblJCLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 5, -1, -1));
    ...
    private void cerrarVentana() {
        InspeccionReciboGUI22.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InspeccionReciboGUI22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new InspeccionReciboGUI22().setVisible(true);
        });
    }
