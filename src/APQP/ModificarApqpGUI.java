...
public class ModificarApqpGUI extends javax.swing.JFrame {

    // Atributos
    private ApqpM actividad; // Manejo de la información de la actividad
    private Usuarios usuario; // Usuario autenticado en la aplicación
    private ApqpServicio apqps; // Servicio para manejar el control de las actividades y documentos
    private Connection conexion; // Conexión a la Base de Datos

    public ModificarApqpGUI() {
        initComponents();
    }

    public ModificarApqpGUI(Usuarios usuario, ApqpM actividad) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 430, 130, 50));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 430, 130, 50));
        ...
        jPanel1.add(txtNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 350, -1));
        jPanel1.add(txtPuntosYRequerimientos, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 330, -1));

        txtAnalisisFactibilidad.setToolTipText("");
        jPanel1.add(txtAnalisisFactibilidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 330, -1));
        jPanel1.add(txtEquipoGerencial, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, 350, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (validarCampos()) {
            actualizarActividadDesdeFormulario();
            apqps.guardarCambios(conexion, actividad);
    ...
    private void inicializarCampos() {
        txtEtapa.setText(actividad.getEtapa());
        txtNo.setText(actividad.getActividad());
        txtPuntosYRequerimientos.setText(actividad.getRequerimientos());
        txtAnalisisFactibilidad.setText(actividad.getFactibilidad());
        txtEquipoGerencial.setText(actividad.getEquipo());
    }

    private boolean validarCampos() {
        return !txtEtapa.getText().isEmpty()
                && !txtNo.getText().isEmpty()
                && !txtPuntosYRequerimientos.getText().isEmpty()
                && !txtAnalisisFactibilidad.getText().isEmpty()
                && !txtEquipoGerencial.getText().isEmpty();
    }

    private void actualizarActividadDesdeFormulario() {
    ...
    private void notificarActualizacion() {
        cerrarVentana();
        JOptionPane.showMessageDialog(this, "DATOS DE LA ACTIVIDAD ACTUALIZADOS EXITOSAMENTE");
        apqps.abrirApqpGUI(usuario);
    }

    private void cerrarVentana() {
        ModificarApqpGUI.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarApqpGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new ModificarApqpGUI().setVisible(true);
        });
    }
