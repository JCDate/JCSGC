 ...
 * @author JC
 */
public class HojaInstruccion extends javax.swing.JFrame {
     ...
     */
    public HojaInstruccion() throws SQLException, ClassNotFoundException {
        initComponents(); // Inicialización de Componentes
        inicializarVentana(); // Se inicializan los componente principales
    }

    public HojaInstruccion(Usuarios usr, InspeccionReciboM irm) throws SQLException, ClassNotFoundException {
        initComponents(); // Inicialización de Componentes
        inicializarVentana(); // Se inicializan los componente principales
    ...
    public HojaInstruccion(Usuarios usr, InspeccionReciboM irm, DatosIRM dirm, List<AnchoLargoM> anchoLargoList) throws SQLException, ClassNotFoundException {
        initComponents(); // Inicialización de Componentes
        inicializarVentana(); // Se inicializan los componente principales
        this.usr = usr; // Se asigna el valor de la instancia de usuarios
        this.irm = irm; // Se asigna el valor de la instancia de InspeccionReciboM
        ...
        txtHojaInstrucciones.setText(String.valueOf(irm.getNoHoja())); // Se muestra el no. que tiene la hoja de instrucción     
        txtDescripcionMP.setText(dirm.getDescripcionMP());
        ...
        try {
            ...
            Logger.getLogger(HojaInstruccion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblLecturaMuestreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 160, -1, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 240, 190));
        ...
        jPanel1.add(chkAceptacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 530, 100, 40));
        ...
        jPanel1.add(chkRechazo, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 530, 90, 40));
        ...
        jPanel1.add(lblPunto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 190, 410, 100));
        ...
        jPanel1.add(lblInstruccionesInspeccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 180, -1, -1));

        lblPunto2.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        lblPunto2.setForeground(new java.awt.Color(76, 109, 255));
        lblPunto2.setText("2.- Se evalua el aspecto dimensional, midiendo el espesor como se indica en la figura.");
        jPanel1.add(lblPunto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 280, -1, -1));
        ...
        jPanel1.add(lblNota, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 300, -1, -1));
        ...
        jPanel1.add(lblDescripcionMPR, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, -1, -1));
        ...
        jPanel1.add(lblCalibreLamina, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, -1, -1));
        jPanel1.add(txtDescripcionMP, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 280, -1));
        ...
        jPanel1.add(cbxLamina, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 280, 30));
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ...
        dirm.setDescripcionMP(txtDescripcionMP.getText()); // Se Captura la descripción de materia prima
        ...
        int codigo = s.auto_increment("SELECT MAX(idAnchoLargo) FROM datosir"); // Se obitene el máximo valor del campo idAnchoLargo y se le aumenta 1

        dirm.setAnchoLargo(codigo); // Se guarda el valor capturado.    
        HojaInstruccion.this.dispose(); // Se liberan los recursos de la ventana
        try {
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        HojaInstruccion.this.dispose(); // Se liberan los recursos de la interfaz
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HojaInstruccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> { // Crea y muestra el form
            try {
                new HojaInstruccion().setVisible(true);
